...
/*
 * Java dto for entity table addresses 
...
/**
 * DTO customize for table "addresses"
 * 
...
public class _AddressesDto implements Cloneable {
	...
	protected SearchParam<String>   labelParam            ;                     
	protected SearchParam<String>   streetAddressParam    ;                     
	protected SearchParam<String>   cityParam             ;                     
	protected SearchParam<String>   stateParam            ;                     
	protected SearchParam<String>   postalCodeParam       ;                     
	protected SearchParam<String>   countryParam          ;                     
	protected SearchParam<Boolean>  isDefaultParam        ;                     
